...
function index()
	...
	entry({"admin", "modem", "sms"}, alias("admin", "modem", "sms", "atcommands"), translate("AT/Messages"), 20).acl_depends={ "luci-app-sms-tool" }
	entry({"admin", "modem", "sms", "atcommands"},template("modem/atcommands"),translate("AT Commands"), 10)
	entry({"admin", "modem", "sms", "readsms"},template("modem/readsms"),translate("Received Messages"), 20)
 	entry({"admin", "modem", "sms", "sendsms"},template("modem/sendsms"),translate("Send Messages"), 30)
 	entry({"admin", "modem", "sms", "ussd"},template("modem/ussd"),translate("USSD Codes"), 40)
